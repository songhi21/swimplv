$(document).ready(function() {
    ...
    var table2 = $('#devhistory-table').DataTable({
        "scrollX": true,
        "paging": true,
        ...
        "ajax": {
            "url": "/getDatadevicehistoricaldata-admin/" + idps,
            "type": "GET",
            "data": function (d) {
                d.start_date = $('#start').val();
                d.end_date = $('#end').val();
            },
            "dataSrc": "data", // Assuming your response data is wrapped in a 'data' property
        ...
        "columns": [
            ...
            { "data": "deviceid" }, // Assuming your response has a 'deviceid' field
            { "data": "devicename" }, 
            { "data": "numericalvalue" },
            { "data": "datetime" }
        ],
    ...
    window.onload = function () {
        ...
        $('#devhistory-table').on('draw.dt', function () {
            updateChartWithDataTableData();
        });
    }
    $('#btnSubmit').on('click', function() {
        ...
        table2.ajax.url("/getDatadevicehistoricaldata-admin/" + idps + "?date_start=" + startDateT+":00" + "&date_end=" + endDateT+":00").load();
    ...
    $('#devhistory-table').on('length.dt draw.dt', function(e, settings, len) {
