...
var map = new ol.Map({
    ...
    view: new ol.View({
      ...
      projection: new ol.proj.Projection({
        code: 'EPSG:32651',
        extent: [-30037508.342789, -30037508.342789, 20037508.342789, 20037508.342789],
        units: 'm'
      })
    })
  });
  ...
  // Fit the map to the center
  map.getView().fit([338017.295778, 1834529.941474, 426393.607501, 1890883.928694], map.getSize());
