...
<head class="border-red">
   ...
   {{-- <script src="path/to/leaflet/qgis_exported_map.js"></script>
   <script src="path/to/leaflet/qgis_exported_map.js"></script> --}}
                    ...
                    <ul class="navbar-nav text-navconf">
                        ...
                        <li >
                            <li class="nav-item dropdown">
                                <a   role="button" class="{{ Request::segment(1) == 'maps' ? 'bn632-hover bn26' : null}} nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Data</a>
                                </a>
