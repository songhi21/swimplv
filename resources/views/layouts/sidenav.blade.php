...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        {{-- <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/SWim logo 2.png" alt="logo" /></a> --}}
    ...
    <ul class="nav">
        ...
        <div class="profile-desc">
            ...
            @if(Auth::check())
                @if(Auth::user()->type == "Admin")
                    <a href="{{ config('variable.url') }}useraccount" class="dropdown-item preview-item">
            ...
            <a href="{{ config('variable.url') }}userchangepassword" class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                <div class="preview-icon bg-dark rounded-circle">
        ...
        <li class="nav-item menu-items">
            {{-- <a class="nav-link " {{ Request::segment(1) === 'home'  ? "" : "href="."home" }} > --}}
