            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 " >
                                <form action="<?php echo e(route('searchcctv')); ?>" method="get">
                                ...
                                <?php if(isset($_GET['searchinput'])): ?>
                                    <a href="<?php echo e(route('cctvview.index')); ?>" type="button" class="btn btn-outline-secondary">
                    ...
                    <div class="row">
                        <?php if(isset($result)): ?>
                            <?php foreach($result as $index=> $data):?>
                                    ...
                                    <div class="col-lg-4">
                                        <?php echo $__env->make('cctvviewmodal.cardtable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <br>
                                </div>
                ...
                <div class="col-lg-12 col-xl-12 text-center">
                    ...
                    <div class="text-center3 ">
                        <?php if(isset($_GET['searchinput'])): ?>
                            ...
                            <?php echo e($cctvview->appends(['searchinput' => $_GET['searchinput']])->links('pagination::bootstrap-4')); ?>

                        <?php else: ?>
                            <?php echo e($cctvview->fragment('tab')->links('pagination::bootstrap-4')); ?>

                        <?php endif; ?>
                    </div>
                    <p> <?php echo e("Showing ".$cctvview->CurrentPage() ." to ".$cctvview->lastPage() ." of ". count($cctvview) . " entries ". " about ".$cctvview->total()); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('cctvviewmodal.createmodal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\central-gulp\swimplv\resources\views/cctvview.blade.php ENDPATH**/ ?>