<div class="modal fade" id="edit<?php echo $id ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(route('cctvview.update',$id)); ?>" method="POST" class="formsurv">
  ...
  </div><?php /**PATH C:\xampp\htdocs\central-gulp\swimplv\resources\views/cctvviewmodal/editmodal.blade.php ENDPATH**/ ?>