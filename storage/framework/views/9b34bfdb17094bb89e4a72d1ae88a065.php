<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo e(route('hub.store')); ?>" method="POST" class="formsurv">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="link" class="form-label textcolorwhite">Link</label>
  ...
  </div><?php /**PATH C:\xampp\htdocs\central-gulp\swimplv\resources\views/wshmodal/create.blade.php ENDPATH**/ ?>