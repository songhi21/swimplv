  ...
  <div class="modal-dialog "  role="document">
    <div class="modal-content textcolorwhite">
      ...
      <div class="modal-footer text-center">
          <form action="<?php echo e(route('useraccount.destroy',$id)); ?> " method="POST" class="formsurv">
              <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\central-gulp\swimplv\resources\views/account/deletewsh.blade.php ENDPATH**/ ?>